        ...
        when (tipusFigura) {
            ...
            "ellipse" -> {
                try {
                    val x = figura[1].toInt()
                    val y = figura[2].toInt()
                    val radi_x = figura[3].toInt()
                    val radi_y = figura[4].toInt()
                    val color = figura[5]

                    // Si tot és correcte creem la figura rectangle
                    var nouElli = Ellipse(x, y, radi_x, radi_y, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouElli)
                } catch (err: Exception) {
                    println("\u001B[31m Arguments incorrectes \u001B[0m")
            ...
            "cercle" -> {
                try {
                    ...
                    // Si tot és correcte creem la figura rectangle
                    var nouCerc = Cercle(x, y, radi, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouCerc)
                } catch (err: Exception) {
                    println("\u001B[31m Arguments incorrectes \u001B[0m")
